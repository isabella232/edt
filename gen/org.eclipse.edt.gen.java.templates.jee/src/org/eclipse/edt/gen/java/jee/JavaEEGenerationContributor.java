...
public class JavaEEGenerationContributor implements GenerationContributor {
	...
	static {
		templatePath = new String[] { 
			"org.eclipse.edt.gen.java.templates.jee.templates"
		};
	}
	// define the list of native type directories for this generator
	static {
		nativeTypePath = new String[] { 
			"org.eclipse.edt.gen.java.jee.nativeTypes"
		};
	}
