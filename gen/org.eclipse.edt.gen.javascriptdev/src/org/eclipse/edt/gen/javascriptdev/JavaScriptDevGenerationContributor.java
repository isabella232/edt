...
public class JavaScriptDevGenerationContributor implements GenerationContributor {
	...
	static {
		templatePath = new String[] { 
			"org.eclipse.edt.gen.javascriptdev.templates.templates"
		};
	}
	...
	static {
		...
		nativeTypePath = new String[] { 
			"org.eclipse.edt.gen.javascriptdev.nativeTypes"
		};
	}
