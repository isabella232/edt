...
//			"ExtendComments must be defined as true or false");
	...
	public String[] getNativeTypePath() {
		// if we are going to add our own system type, implemented as a java library, we need to provide the details in the
		...
		nativeTypes.add("org.eclipse.edt.gen.javascriptdev.nativeTypes");
	...
	public String[] getTemplatePath() {
		...
		templates.add("org.eclipse.edt.gen.javascriptdev.templates.templates");
		// Now add the ones we are extending
