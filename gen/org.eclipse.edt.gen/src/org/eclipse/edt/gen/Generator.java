...
public abstract class Generator {
	...
	public boolean verifyPartSupported(Object obj, String generatorName, String methodName, Object...args) {
		if (obj instanceof Part) {
			Part part = (Part)obj;
			Annotation ann = part.getStereotype();
			if (ann != null) {
				//If the part has a subtype, the generator MUST have a template defined to handle that subtype
				if (context.getTemplateForEClassifier(ann.getEClass()) == null) {
				...
				if (!(part instanceof AnnotationType) && !context.hasMethodFor(part, methodName, args)) {
