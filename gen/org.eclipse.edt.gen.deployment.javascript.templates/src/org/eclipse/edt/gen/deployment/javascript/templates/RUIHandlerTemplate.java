...
public class RUIHandlerTemplate extends RUITemplate {
	...
	public void genDeploymentHTML(Handler handler, Context ctx, TabbedWriter out, String egldd, HashMap eglParameters, String userMsgLocale, String runtimeMsgLocale) {		
	...
	private void genHTML(Handler handler, Context ctx, TabbedWriter out, String egldd, HashMap eglParameters, String userMsgLocale, String runtimeMsgLocale){
		genHTML(false, handler, ctx, out, egldd, eglParameters, userMsgLocale, runtimeMsgLocale, false, false, false);
	}
