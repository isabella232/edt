...
public class EglGenerationContribution implements GenerationContribution {
	...
	static {
		templatePath = new String[] { 
			"org.eclipse.edt.gen.egl.templates.templates"
		};
	}
	// define the list of native type directories for this generator
	static {
		nativeTypePath = new String[] { 
			"org.eclipse.edt.gen.egl.templates.nativeTypes"
		};
	}
