	...
	'eze$$runtimePropertiesFile': 'org.eclipse.edt.eunit.runtime.LogResult',
		...
		"assertBigIntEqual": function(message, expected, actual) {
			try { egl.enter("assertBigIntEqual",this,arguments);
				...
				this.expectAssertTrue(message, {eze$$value : expected, eze$$signature : egl.inferSignature(expected)}, {eze$$value : actual, eze$$signature : egl.inferSignature(actual)}, isEqual);
		...
		"isFloatEqual": function(expected, actual) {
			try { egl.enter("isFloatEqual",this,arguments);
				...
				var eze$Temp11 = 0;
				var eze$Temp12 = egl.eglx.lang.EAny.ezeWrap(0);
				...
				var eze$Temp17 = "";
				var eze$Temp18 = egl.eglx.lang.EAny.ezeWrap("");
				egl.atLine(this.eze$$fileName,229,6729,47, this);
		...
		"expectAssertTrue": function(message, expected, actual, isEqual) {
			try { egl.enter("expectAssertTrue",this,arguments);
				...
				var failedReason = "";
				egl.addLocalFunctionVariable("failedReason", failedReason, "eglx.lang.EString", "failedReason");
				egl.atLine(this.eze$$fileName,240,7151,44, this);
				failedReason = this.buildFailedReason(message, expected, actual);
				egl.setLocalFunctionVariable("failedReason", failedReason, "eglx.lang.EString");
				egl.atLine(this.eze$$fileName,241,7200,34, this);
				this.assertTrue(failedReason, isEqual);
				egl.atLine(this.eze$$fileName,239,7021,221, this);
				if (!egl.debugg) egl.leave();
			} finally {
				if (!egl.debugg){
				} else { egl.leave(); }
		...
		"buildFailedReason": function(message, expected, actual) {
			try { egl.enter("buildFailedReason",this,arguments);
				...
				var failedReason = "";
				egl.addLocalFunctionVariable("failedReason", failedReason, "eglx.lang.EString", "failedReason");
				egl.atLine(this.eze$$fileName,245,7376,24, this);
				failedReason = this.expect(expected, actual);
				egl.setLocalFunctionVariable("failedReason", failedReason, "eglx.lang.EString");
				egl.atLine(this.eze$$fileName,246,7405,95, this);
				if ((((egl.eglx.lang.NullType.notEquals(message, null)) && ((message) != "")))) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,247,7447,46, this);
						failedReason = ((((message) + " - ")) + failedReason);
						egl.setLocalFunctionVariable("failedReason", failedReason, "eglx.lang.EString");
					}finally{egl.exitBlock();}
				}
				egl.atLine(this.eze$$fileName,249,7504,22, this);
				if (!egl.debugg) egl.leave();
				return failedReason;
			} finally {
				if (!egl.debugg){
		...
		"expect": function(expected, actual) {
			try { egl.enter("expect",this,arguments);
				...
				egl.atLine(this.eze$$fileName,253,7643,88, this);
				...
				egl.atLine(this.eze$$fileName,254,7742,21, this);
				if (!egl.debugg) egl.leave();
				return standardMsg;
			} finally {
				if (!egl.debugg){
		...
		"normalFloat": function(afloat, mantissa, sign) {
			try { egl.enter("normalFloat",this,arguments);
				...
				egl.atLine(this.eze$$fileName,259,7895,13, this);
				mantissa.ezeCopy(0);
				egl.setLocalFunctionVariable("mantissa", mantissa, "eglx.lang.EInt");
				egl.atLine(this.eze$$fileName,260,7918,127, this);
				if (((afloat >= 0))) {
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,261,7947,11, this);
						sign.ezeCopy("+");
					...
					try{egl.enterBlock();
						egl.atLine(this.eze$$fileName,263,7986,11, this);
						sign.ezeCopy("-");
						egl.setLocalFunctionVariable("sign", sign, "eglx.lang.EString");
						egl.atLine(this.eze$$fileName,264,8011,21, this);
						afloat = ((afloat * -1));
