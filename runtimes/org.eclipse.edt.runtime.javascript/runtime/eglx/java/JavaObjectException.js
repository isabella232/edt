...
egl.createJavaObjectException = function( /*string*/ messageID, /*string or array*/ inserts )
{
	...
	args.push( [ "exceptionType", arguments[ 2 ] || "" ] );
	return new egl.egl.java.JavaObjectException( args );
}

egl.defineClass( "eglx.java", "JavaObjectException", "egl.lang", "AnyException", {
	
	//JavaObjectException requires the following additional data:
	//name
	
	"eze$$getChildVariables" : function() {
		var childVars = this.eze$$superClass.prototype.eze$$getChildVariables.call( this );
		childVars.push({name : "exceptionType", value : exceptionType, type : "eglx.lang.EString"});
		return childVars;
	}
