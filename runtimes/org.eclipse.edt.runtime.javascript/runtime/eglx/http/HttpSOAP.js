 ...
 *******************************************************************************/
egl.defineClass('eglx.http', "HttpSOAP", "egl.jsrt", "Record", {
	"eze$$fileName" : "eglx/http/HttpSOAP.egl",
		...
		"eze$$setInitial": function() {
			...
			this.request.contentType = "application/soap";
		...
		"eze$$clone": function() {
			...
			ezert$$2.soapMessage = ezert$$1.soapMessage;
		...
		"eze$$getFieldInfos": function() {
			if(this.fieldInfos === undefined){
				...
				annotations = {};
				annotations["XMLStyle"] = new egl.eglx.xml.binding.annotation.XMLElement("soapMessage", null, false, false);
				annotations["JsonName"] = new egl.eglx.json.JsonName("soapMessage");
				this.fieldInfos[2] =new egl.eglx.services.FieldInfo("soapMessage", "soapMessage", "A;", egl.eglx.jws.SOAPEnvelope, annotations);
			}
		...
		"eze$$resolvePart": function(/*string*/ namespace, /*string*/ localName) {
			if(this.namespaceMap == undefined){
				this.namespaceMap = {};
				this.namespaceMap["##default{HttpSOAP}"] = "eglx.http.HttpSOAP";
			}
			var newObject = null;
