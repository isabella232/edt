...
public class ImportOrganizePreferencePage extends PropertyAndPreferencePage {
	...
	public static final String PREF_ID= "org.eclipse.edt.ide.ui.organizeImportsPreferencePage"; //$NON-NLS-1$
	public static final String PROP_ID= "org.eclipse.edt.ide.ui.organizeImportsPropertyPage"; //$NON-NLS-1$
	...
	public ImportOrganizePreferencePage() {
		...
		setTitle(UINlsStrings.ImportOrganizePreferencePage_title);		 
	}
	...
	public void createControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, IUIHelpConstants.ORGANIZE_IMPORTS_PREFERENCE_PAGE);
	}
	...
	protected String getPropertyPageID() {
		//Uncomment if there is ever a project property page for org. imports
		//return PROP_ID ;
		return null;
	}
