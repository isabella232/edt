...
public class ProjectSelectionDialog extends SelectionStatusDialog {
	...
	public ProjectSelectionDialog(Shell parentShell, Set projectsWithSpecifics) {
		super(parentShell);
		setTitle(UINlsStrings.ProjectSelectionDialog_title);  
		setMessage(UINlsStrings.ProjectSelectionDialog_desciption); 
	...
	protected void updateFilter(boolean selected) {
		...
		EDTUIPlugin.getDefault().getDialogSettings().put(DIALOG_SETTINGS_SHOW_ALL, !selected);
	}
