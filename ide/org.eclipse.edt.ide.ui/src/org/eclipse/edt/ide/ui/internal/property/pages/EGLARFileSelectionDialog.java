 ...
 */
public class EGLARFileSelectionDialog extends FilteredElementTreeSelectionDialog {
	 ...
	 */
	public EGLARFileSelectionDialog(Shell parent, boolean multiSelect, boolean acceptFolders) {
	 ...
	 */
	public EGLARFileSelectionDialog(Shell parent, boolean multiSelect, boolean acceptFolders, boolean acceptAllArchives) {
		...
		if (!acceptAllArchives) {
			...
			setInitialFilter(ArchiveFileFilter.EGLAR_FILTER_STRING);
		}
	...
	private static class FileLabelProvider extends LabelProvider {
		...
		private final Image IMG_JAR= PluginImages.get(PluginImages.IMG_OBJS_JAR);
