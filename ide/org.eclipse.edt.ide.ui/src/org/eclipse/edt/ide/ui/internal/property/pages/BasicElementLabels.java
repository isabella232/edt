...
public class BasicElementLabels {
	...
	public static String getPathLabel(File file) {
		return StringUtility.markLTR(file.getAbsolutePath(), "");  //$NON-NLS-1$
	}
	...
	public static String getFilePattern(String name) {
		return StringUtility.markLTR(name, "*.?"); //$NON-NLS-1$
	}
	...
	public static String getJavaCodeString(String string) {
		return StringUtility.markLTR(string, "<>()?,{}+-*!%="); //$NON-NLS-1$
	}
	...
	public static String getWorkingSetLabel(IWorkingSet set) {
		return StringUtility.markLTR(set.getLabel(), "");  //$NON-NLS-1$
	}
