...
public class TogglePresentationAction extends TextEditorAction implements IPropertyChangeListener {
	...
	public static final String PREFIX= JavaUI.ID_PLUGIN + '.';  //Copied from IJavaHelpContextIds
	...
	public TogglePresentationAction() {
		super(UINlsStrings.getResourceBundleForConstructedKeys(), "TogglePresentation.", null); //$NON-NLS-1$
		PluginImages.setToolImageDescriptors(this, "segment_edit.gif"); //$NON-NLS-1$
		setToolTipText(UINlsStrings.getResourceBundleForConstructedKeys().getString("TogglePresentation.tooltip")); //$NON-NLS-1$
