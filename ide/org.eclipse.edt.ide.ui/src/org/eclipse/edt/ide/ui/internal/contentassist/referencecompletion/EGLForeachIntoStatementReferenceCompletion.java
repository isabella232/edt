...
public class EGLForeachIntoStatementReferenceCompletion extends EGLAbstractReferenceCompletion {

	/* (non-Javadoc)
	 * @see org.eclipse.edt.ide.ui.internal.contentassist.EGLAbstractReferenceCompletion#precompileContexts()
	 */
	protected void precompileContexts() {
		addContext("package a; function a() foreach (a into"); //$NON-NLS-1$
		addContext("package a; function a() foreach (a into x, "); //$NON-NLS-1$
	}
			...
			getBoundASTNodeForOffsetInStatement(viewer, documentOffset, new IBoundNodeProcessor() {public void processBoundNode(Node boundNode) {
				...
				proposals.addAll(
					new EGLDeclarationProposalHandler(viewer,
						...
						prefix,
						boundNode)
							.getDataItemProposals(EGLDeclarationProposalHandler.ALL_DATAITEMS, false));
			}});		
		}
		return proposals;
	}
