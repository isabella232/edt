...
/**
 * A <code>TextChangeManager</code> manages associations between <code>IEGLFile</code>
 * or <code>IFile</code> and <code>TextChange</code> objects.
 */
public class TextChangeManager {
	
	private Map/*<IEGLFile, TextChange>*/ fMap= new HashMap(10);
	...
	public TextChange[] getAllChanges(){
		...
		IEGLFile[] cus= (IEGLFile[]) cuSet.toArray(new IEGLFile[cuSet.size()]);
		// sort by cu name:
	...
	public IEGLFile[] getAllCompilationUnits(){
		return (IEGLFile[]) fMap.keySet().toArray(new IEGLFile[fMap.keySet().size()]);
	}
