...
public class NewRecordSummaryPage extends WizardPage {
	...
	public void setMessages(java.util.List<String> messages) {
		...
		if (messageList.getItemCount() == 0) {
			...
			warningLabel.setText(NewRecordWizardMessages.bind(NewRecordWizardMessages.NewRecordSummaryPage_warningLabel2,new String[] {Integer.toString(messageList.getItemCount())}));
		}
	}
