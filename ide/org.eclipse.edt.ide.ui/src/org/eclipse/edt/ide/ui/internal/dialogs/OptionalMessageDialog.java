...
public class OptionalMessageDialog extends MessageDialog {
	...
	private static final String CHECKBOX_TEXT= UINlsStrings.OptionalMessageDialog_dontShowAgain;  
	...
	private static IDialogSettings getDialogSettings() {
		...
		if (settings == null)
			settings= EDTUIPlugin.getDefault().getDialogSettings().addNewSection(STORE_ID);
		return settings;
	}
