...
public class PropertiesFileUtil {
	...
	public PropertiesFileUtil(String includeStatement){
		String temp = new Path(includeStatement).removeFileExtension().toString();
	...
	public static String convertToProperitesFile(String includeStatement){
		IPath path = new Path(includeStatement);
		return path.removeFileExtension().addFileExtension("properties").toString();
	}
}
