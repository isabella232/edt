...
public interface ILocaleConstants {
	...
	public static String Locale_Description_English = RUINlsStrings.locale_English;
	public static String Locale_Key_English = "en_US"; //$NON-NLS-1$
	public static String Locale_Key_English_Runtime = "en_US"; //$NON-NLS-1$
	
	public static String Locale_Description_Arabic = RUINlsStrings.locale_Arabic;
	public static String Locale_Key_Arabic_Runtime = "ar"; //$NON-NLS-1$

	public static String Locale_Description_Arabic_Egypt = RUINlsStrings.locale_Arabic_Egypt;
	public static String Locale_Key_Arabic_Egypt = "ar_EG"; //$NON-NLS-1$
	
	public static String Locale_Description_Arabic_Saudi_Arabia = RUINlsStrings.locale_Arabic_Saudi_Arabia;
	public static String Locale_Key_Arabic_Saudi_Arabia = "ar_SA"; //$NON-NLS-1$

	public static String Locale_Description_Brazilian = RUINlsStrings.locale_Brazilian;
	...
	public static String Locale_Description_Chinese_Simplified = RUINlsStrings.locale_Chinese_Simplified;
	...
	public static String Locale_Description_Chinese_Taiwan = RUINlsStrings.locale_Chinese_Taiwan;
	...
	public static String Locale_Description_Chinese_Hong_Kong = RUINlsStrings.locale_Chinese_Hong_Kong;
