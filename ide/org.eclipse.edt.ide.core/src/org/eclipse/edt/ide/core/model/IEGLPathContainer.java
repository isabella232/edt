...
/** 
 * Interface of a EGLPath container.
 ...
 * <p>
 * The set of entries associated with a EGLPath container may contain any of the following:
 * <ul>
 * <li> library entries (<code>CPE_LIBRARY</code>) </li>
 * <li> project entries (<code>CPE_PROJECT</code>) </li>
 * </ul>
 * In particular, a EGLPath container can neither reference further EGLPath containers or EGLPath variables.
 * <p>
 * EGLPath container values are persisted locally to the workspace, but are not preserved from a 
 * session to another. It is thus highly recommended to register a <code>EGLPathContainerInitializer</code> 
 * for each referenced container (through the extension point "org.eclipse.jdt.core.EGLPathContainerInitializer").
 * <p>
 * @see IEGLPathEntry
 * @since 2.0
 */
...
public interface IEGLPathContainer {
	...
	/**
	 * Answers the set of EGLPath entries this container is mapping to.
	 * <p>
	 * The set of entries associated with a EGLPath container may contain any of the following:
	 * <ul>
	 * <li> library entries (<code>CPE_LIBRARY</code>) </li>
	 * <li> project entries (<code>CPE_PROJECT</code>) </li>
	 * </ul>
	 * A EGLPath container can neither reference further EGLPath containers or EGLPath variables.
	 * 
	 * @return IEGLPathEntry[] - the EGLPath entries this container represents
	 * @see IEGLPathEntry
	 */	
	 ...
	 * <p>
	 * The container ID is also used to identify a<code>EGLPathContainerInitializer</code>
	 * registered on the extension point "org.eclipse.jdt.core.EGLPathContainerInitializer", which can
