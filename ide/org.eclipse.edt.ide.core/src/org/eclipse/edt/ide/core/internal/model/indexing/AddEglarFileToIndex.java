...
public class AddEglarFileToIndex extends IndexRequest {
	...
	private static final String JAR_FILE_ENTRY_SEPARATOR = "|";
...
//				if (!this.manager.resetIndex(this.indexPath)) {
//					// failed to recreate index, see 73330
//					this.manager.removeIndex(this.indexPath);
//					return false;
//				}
//				index.separator = JAR_SEPARATOR;
				BinaryIndexer binaryIndexer = new BinaryIndexer();
				...
				for (Enumeration e = zip.entries(); e.hasMoreElements();) {
					...
					if (org.eclipse.edt.ide.core.internal.model.Util.isEGLIRFileName(zipEntryName) && 
						...
						String path = ((IPath)zipFilePath) + JAR_FILE_ENTRY_SEPARATOR + ze.getName();
