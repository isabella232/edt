...
/**
 * Common protocol for EGL elements that support source code manipulations such
 ...
 * @exception EGLModelException if this element could not be copied. Reasons include:
 * <ul>
 * <li> This EGL element, container element, or sibling does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 ...
 */
void copy(IEGLElement container, IEGLElement sibling, String rename, boolean replace, IProgressMonitor monitor) throws EGLModelException;
/**
 ...
 * @param monitor a progress monitor
 * @exception EGLModelException if this element could not be deleted. Reasons include:
 * <ul>
 ...
 * </ul>
 */
void delete(boolean force, IProgressMonitor monitor) throws EGLModelException;
/**
 ...
 *   exception in the event of a name collision
 * @param monitor a progress monitor
 * @exception EGLModelException if this element could not be moved. Reasons include:
 * <ul>
 * <li> This EGL element, container element, or sibling does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 * <li> A <code>CoreException</code> occurred while updating an underlying resource
 * <li> The container is of an incompatible type (INVALID_DESTINATION)
 ...
 * @exception IllegalArgumentException if container is <code>null</code>
 */
void move(IEGLElement container, IEGLElement sibling, String rename, boolean replace, IProgressMonitor monitor) throws EGLModelException;
/**
 ...
 * @param monitor a progress monitor
 * @exception EGLModelException if this element could not be renamed. Reasons include:
 * <ul>
 * <li> This EGL element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
 * <li> A <code>CoreException</code> occurred while updating an underlying resource
 * <li> The new name is invalid (INVALID_NAME)
 ...
 * </ul>
 */
void rename(String name, boolean replace, IProgressMonitor monitor) throws EGLModelException;
}
