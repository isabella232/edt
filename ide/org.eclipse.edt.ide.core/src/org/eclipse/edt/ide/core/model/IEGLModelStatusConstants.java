 ...
 */
public interface IEGLModelStatusConstants {
	 ...
	 */
	  ...
	  * @since 2.1
	  */
	 public static final int INVALID_EGLPATH_FILE_FORMAT = 1000;

	 /**
	  * Status indicating that a project is involved in a build path cycle.
	  * @since 2.1
	  */
	 public static final int EGLPATH_CYCLE = 1001;
	...
	public static final int DISABLED_CP_MULTIPLE_OUTPUT_LOCATIONS = 1003;
	 ...
	 /**
	  * Status indicating that a .EGLBuildDescriptors file is ill-formed, and thus cannot
	  * be read/written successfully.
	  */
	 public static final int INVALID_EGL_PROJECT_INFO_FILE_FORMAT = 1004;
}
