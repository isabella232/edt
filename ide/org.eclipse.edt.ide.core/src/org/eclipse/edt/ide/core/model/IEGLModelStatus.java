...
/**
 * Represents the outcome of an EGL model operation. Status objects are
 * used inside <code>EGLModelException</code> objects to indicate what went
 * wrong.
 * <p>
 * EGL model status object are distinguished by their plug-in id:
 ...
 * </p>
 * <p>
 * A EGL model status may also carry additional information (that is, in 
 * addition to the information defined in <code>IStatus</code>):
 * <ul>
 *   <li>elements - optional handles to EGL elements associated with the failure</li>
 ...
 */
public interface IEGLModelStatus extends IStatus {
/**
 * Returns any EGL elements associated with the failure (see specification
 * of the status code), or an empty array if no elements are related to this
 * particular status code.
 *
 * @return the list of EGL element culprits
 * @see IEGLModelStatusConstants
 */
 ...
 * @see IEGLModelStatusConstants#DEVICE_PATH
 * @see IEGLModelStatusConstants#INVALID_PATH
 * @see IEGLModelStatusConstants#PATH_OUTSIDE_PROJECT
 * @see IEGLModelStatusConstants#RELATIVE_PATH
 */
IPath getPath();
/**
...
String getString();
/**
 * Returns whether this status indicates that a EGL model element does not exist.
 * This convenience method is equivalent to
 * <code>getCode() == IEGLModelStatusConstants.ELEMENT_DOES_NOT_EXIST</code>.
 *
 * @return <code>true</code> if the status code indicates that a EGL model
