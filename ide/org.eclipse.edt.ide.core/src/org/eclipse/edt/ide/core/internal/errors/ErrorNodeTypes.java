...
public class ErrorNodeTypes {
  ...
  /* non terminals */
  static final int getByPositionSource = 41;
  static final int onException_star = 135;
  static final int programParameter_star = 141;
  static final int structureContent_star = 155;
  static final int forwardTargetOpt = 35;
  static final int occursOpt = 61;
  static final int fromExprOpt = 36;
  static final int enumerationField = 21;
  static final int getByPositionOption = 40;
  static final int inlineSQLStatementOpt = 47;
  static final int foreachTarget = 31;
  static final int attrTypeOpt = 8;
  static final int exitModifierOpt = 25;
  static final int handlerContent = 15;
  static final int functionParameter = 38;
  static final int setting_plus = 148;
  ...
  static final int partSubTypeOpt = 67;
  static final int onException = 62;
