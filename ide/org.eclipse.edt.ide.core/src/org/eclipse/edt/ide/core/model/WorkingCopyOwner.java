...
import org.eclipse.edt.ide.core.internal.model.DefaultWorkingCopyOwner;
...
public abstract class WorkingCopyOwner {
	 ...
	 * @since 3.3
	 */
	public IProblemRequestor getProblemRequestor(IEGLFile workingCopy) {
		return null;
	}
	 ...
	 */
	public final IEGLFile newWorkingCopy(String name, IEGLPathEntry[] classpath, IProblemRequestor problemRequestor, IProgressMonitor monitor) throws EGLModelException {
...
//		EGLFile result = new EGLFile((PackageFragment) parent, name, this);
...
//		return result;
	 ...
	 * @since 3.3
	 */
	public final IEGLFile newWorkingCopy(String name, IEGLPathEntry[] classpath, IProgressMonitor monitor) throws EGLModelException {
//		ExternalJavaProject project = new ExternalJavaProject(classpath);
//		IPackageFragment parent = ((PackageFragmentRoot) project.getPackageFragmentRoot(project.getProject())).getPackageFragment(CharOperation.NO_STRINGS);
