...
/**
 * A EGL model region describes a hierarchical set of elements.
 ...
 * Instances can be created via the <code>EGLCore.newRegion</code>.
 * </p>
 *
 * @see EGLCore#newRegion
 */
public interface IRegion {
	 ...
	 */
	boolean contains(IEGLElement element);
	/**
	 ...
	 */
	boolean remove(IEGLElement element);
}
