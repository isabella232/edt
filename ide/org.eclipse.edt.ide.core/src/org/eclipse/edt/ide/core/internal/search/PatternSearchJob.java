...
public class PatternSearchJob implements IJob {
	...
	public boolean execute(IProgressMonitor progressMonitor) {
		...
		if (this.indexSelector == null) {
			this.indexSelector =
				new IndexSelector(this.scope.enclosingProjects(), this.focus, this.isPolymorphicSearch, this.indexManager);
		}
...
//		}
		...
		if (index == null)
			return COMPLETE;
		EGLReadWriteMonitor monitor = indexManager.getMonitorFor(index);
		if (monitor == null)
