...
public class WorkingCopyUnsavedDuplicatePartRequestor implements IDuplicatePartRequestor {
	...
	public WorkingCopyUnsavedDuplicatePartRequestor(IProject project, String packageName, IFile file){
		this.file = file;
		this.packageName = packageName;
		this.duplicatePartsList = WorkingCopyDuplicatePartManager.getInstance().getUnsavedDuplicatePartList(project);
