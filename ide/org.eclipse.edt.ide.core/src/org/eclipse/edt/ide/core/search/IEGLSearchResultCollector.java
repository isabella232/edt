...
/**
 * A <code>IEGLSearchResultCollector</code> collects search results from a <code>search</code>
 ...
 * <p>
 * The <code>IEGLSearchResultCollector</code> is also used to provide a progress monitor to the 
 ...
 * @param enclosingElement the EGL element that contains the character range
 *	<code>[start, end]</code>; the value can be <code>null</code> indicating that
 *	no enclosing EGL element has been found
