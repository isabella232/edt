 ...
 *
 */
public abstract class CreateElementInEGLFileOperation extends EGLModelOperation {
	/**
	 * The compilation unit DOM used for this operation
	 */
//	protected IDOMEGLFile fCUDOM;
//	/**
...
//	 * last.
//	 */
//	protected IEGLElement fAnchorElement = null;
//	/**
...
//	/**
//	 * Constructs an operation that creates a EGL Language Element with
//	 * the specified parent, contained within a compilation unit.
//	 */
//	public CreateElementInEGLFileOperation(IEGLElement parentElement) {
//		super(null, new IEGLElement[]{parentElement});
...
//	 */
//	public void createAfter(IEGLElement sibling) {
...
//	 * of its parent if <code>null</code>.
//	 */
//	public void createBefore(IEGLElement sibling) {
...
//				char[] elementContents = com.ibm.etools.egl.internal.model.internal.core.Util.normalizeCRs(fCreatedElement.getCharacters(), bufferContents);
...
//	 */
//	protected abstract IDOMNode generateElementDOM() throws EGLModelException;
//	/**
//	 * Returns the DOM with the new source to use for the given compilation unit.
//	 */
//	protected void generateNewEGLFileDOM(IEGLFile cu) throws EGLModelException {
...
//		fCUDOM = (new DOMFactory()).createEGLFile(prevSource, cu.getElementName());
...
//	 */
//	protected abstract IEGLElement generateResultHandle();
//	/**
//	 * Creates and returns the handles for the elements this operation created.
//	 */
//	protected IEGLElement[] generateResultHandles() throws EGLModelException {
//		return new IEGLElement[]{generateResultHandle()};
//	}
//	/**
//	 * Returns the compilation unit in which the new element is being created.
//	 */
//	protected IEGLFile getEGLFile() {
//		return getEGLFileFor(getParentElement());
//	}
//	/**
...
//	 *
//	 * @see createAfter(IEGLElement)
//	 * @see createBefore(IEGLElement);
//	 */
//	protected void insertDOMNode(IDOMNode parent, IDOMNode child) {
//		if (fInsertionPolicy != INSERT_LAST) {
//			IDOMNode sibling = ((EGLElement)fAnchorElement).findNode(fCUDOM);
...
//	 */
//	protected void setRelativePosition(IEGLElement sibling, int policy) throws IllegalArgumentException {
//		if (sibling == null) {
//			fAnchorElement = null;
...
//			IEGLElement domPresentParent = fAnchorElement.getParent();
//			if (domPresentParent.getElementType() == IEGLElement.IMPORT_CONTAINER) {
//				domPresentParent = domPresentParent.getParent();
//			}
//			if (!domPresentParent.equals(getParentElement())) {
//				return new EGLModelStatus(IEGLModelStatusConstants.INVALID_SIBLING, fAnchorElement);
//			}
//		}
