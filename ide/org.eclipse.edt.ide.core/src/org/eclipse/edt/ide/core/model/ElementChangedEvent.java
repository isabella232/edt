 ...
 * of a tree of EGLelements. The changes to the elements are described by
 * the associated delta object carried by this event.
 * <p>
 * This class is not intended to be instantiated or subclassed by clients.
 * Instances of this class are automatically created by the EGLmodel.
 * </p>
 *
...
public class ElementChangedEvent extends EventObject {
	 ...
	 * to one or more EGLelement(s) expressed as a hierarchical
	 ...
	 * it ignores the possible resources which have changed outside EGLoperations). 
	 ...
	 *
	 * @param delta the EGLelement delta.
	 */
	public ElementChangedEvent(IEGLElementDelta delta, int type) {
		super(delta);
		this.type = type;
	}
	/**
	 ...
	 */
	public IEGLElementDelta getDelta() {
		return (IEGLElementDelta) source;
	}
