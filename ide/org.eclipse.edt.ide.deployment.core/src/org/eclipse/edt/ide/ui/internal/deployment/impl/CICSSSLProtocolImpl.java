...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CICSSSL Protocol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getConversionTable <em>Conversion Table</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getCtgKeyStore <em>Ctg Key Store</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getCtgKeyStorePassword <em>Ctg Key Store Password</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getCtgLocation <em>Ctg Location</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getCtgPort <em>Ctg Port</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.eclipse.edt.ide.ui.internal.deployment.impl.CICSSSLProtocolImpl#getServerID <em>Server ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CICSSSLProtocolImpl extends ProtocolImpl implements CICSSSLProtocol {
	...
	/**
	 * The default value of the '{@link #getCtgKeyStore() <em>Ctg Key Store</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCtgKeyStore()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getCtgKeyStore() <em>Ctg Key Store</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCtgKeyStore()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getCtgKeyStorePassword() <em>Ctg Key Store Password</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getCtgKeyStorePassword() <em>Ctg Key Store Password</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCtgKeyStorePassword()
	 * @generated
	...
	public void setConversionTable(String newConversionTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__CONVERSION_TABLE, oldConversionTable, conversionTable));
	}
	 ...
	 * @generated
	 */
	public void setCtgKeyStore(String newCtgKeyStore) {
		String oldCtgKeyStore = ctgKeyStore;
		ctgKeyStore = newCtgKeyStore;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE, oldCtgKeyStore, ctgKeyStore));
	}
	 ...
	 * @generated
	 */
	public void setCtgKeyStorePassword(String newCtgKeyStorePassword) {
		String oldCtgKeyStorePassword = ctgKeyStorePassword;
		ctgKeyStorePassword = newCtgKeyStorePassword;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE_PASSWORD, oldCtgKeyStorePassword, ctgKeyStorePassword));
	}
	...
	public void setCtgLocation(String newCtgLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__CTG_LOCATION, oldCtgLocation, ctgLocation));
	}
	...
	public void setCtgPort(String newCtgPort) {
		...
		ctgPort = newCtgPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__CTG_PORT, oldCtgPort, ctgPort));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__LOCATION, oldLocation, location));
	}
	...
	public void setServerID(String newServerID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeploymentPackage.CICSSSL_PROTOCOL__SERVER_ID, oldServerID, serverID));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DeploymentPackage.CICSSSL_PROTOCOL__CONVERSION_TABLE:
				...
				return;
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE:
				setCtgKeyStore((String)newValue);
				return;
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE_PASSWORD:
				setCtgKeyStorePassword((String)newValue);
				return;
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_LOCATION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE:
				return CTG_KEY_STORE_EDEFAULT == null ? ctgKeyStore != null : !CTG_KEY_STORE_EDEFAULT.equals(ctgKeyStore);
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_KEY_STORE_PASSWORD:
				return CTG_KEY_STORE_PASSWORD_EDEFAULT == null ? ctgKeyStorePassword != null : !CTG_KEY_STORE_PASSWORD_EDEFAULT.equals(ctgKeyStorePassword);
			case DeploymentPackage.CICSSSL_PROTOCOL__CTG_LOCATION:
	...
	public String toString() {
		...
		result.append(conversionTable);
		result.append(", ctgKeyStore: ");
		result.append(ctgKeyStore);
		result.append(", ctgKeyStorePassword: ");
		result.append(ctgKeyStorePassword);
