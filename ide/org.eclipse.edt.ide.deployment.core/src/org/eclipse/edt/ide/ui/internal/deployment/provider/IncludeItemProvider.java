...
/**
 * This is the item provider adapter for a {@link org.eclipse.edt.ide.ui.internal.deployment.Include} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Include_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Include_location_feature", "_UI_Include_type"),
				 DeploymentPackage.Literals.INCLUDE__LOCATION,
				 true,
				 false,
				 false,
	...
	{
		String label = ((Include)object).getLocation();
