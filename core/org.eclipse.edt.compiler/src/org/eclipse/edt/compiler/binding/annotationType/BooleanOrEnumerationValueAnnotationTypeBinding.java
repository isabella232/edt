...
abstract class BooleanOrEnumerationValueAnnotationTypeBinding extends AnnotationTypeBinding {
    ...
    public BooleanOrEnumerationValueAnnotationTypeBinding(String caseSensitiveInternedName, EnumerationTypeBinding enumerationType) {
        super(caseSensitiveInternedName, PrimitiveTypeBinding.getInstance(Primitive.ANY));
