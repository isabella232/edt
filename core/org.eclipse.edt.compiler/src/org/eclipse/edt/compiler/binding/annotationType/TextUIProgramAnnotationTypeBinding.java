 ...
 * @author Harmon
 */
class TextUIProgramAnnotationTypeBinding extends PartSubTypeAnnotationTypeBinding {
    public static final String caseSensitiveName = InternUtil.internCaseSensitive("TextUIProgram");
    public static final String name = InternUtil.intern(caseSensitiveName);

    private static TextUIProgramAnnotationTypeBinding INSTANCE = new TextUIProgramAnnotationTypeBinding();
    ...
    public TextUIProgramAnnotationTypeBinding() {
        super(caseSensitiveName, new Object[] {
        	IEGLConstants.PROPERTY_INPUTFORM,	SystemPartManager.INTERNALREF_BINDING,        	
        	IEGLConstants.PROPERTY_SEGMENTED,	PrimitiveTypeBinding.getInstance(Primitive.BOOLEAN)        	
        },
        BasicProgramAnnotationTypeBinding.getInstance());
    }
    
    public static TextUIProgramAnnotationTypeBinding getInstance() {
        return INSTANCE;
    }
