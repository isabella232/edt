...
public class NodeTypes {
  ...
  static final int onException_star = 131;
  static final int programParameter_star = 139;
  static final int structureContent_star = 151;
  static final int forwardTargetOpt = 34;
  static final int occursOpt = 60;
  static final int fromExprOpt = 35;
  static final int enumerationField = 20;
  static final int prepareOption = 68;
  ...
  static final int setting_plus = 144;
  static final int direction = 18;
  static final int staticAccessModifierOpt = 82;
  static final int executeOption_star = 104;
  static final int $START = 0;
  static final int connector = 2;
  static final int settingsBlock = 78;
  static final int returnsOpt = 75;
  static final int addOption_star = 94;
  static final int showOption = 80;
  static final int whenClause_star = 153;
  static final int extendsOpt = 26;
  static final int type = 89;
  static final int packageDeclarationOpt = 64;
  static final int interfaceContent_plus = 126;
  static final int programParameter = 72;
  static final int strItemDecl = 85;
  static final int transferTargetOpt = 88;
  static final int programParametersOpt = 73;
  static final int eventBlock = 21;
  static final int setting = 77;
  static final int eventBlock_plus = 103;
  static final int functionInvocation = 36;
  static final int setTarget = 76;
  static final int formGroupContent_plus = 113;
  static final int functionParameter_plus = 117;
  static final int setting_star = 143;
  static final int name_plus = 130;
  static final int whenClause = 92;
  static final int replaceOption_plus = 142;
  static final int part = 65;
  static final int forwardOption_plus = 115;
  static final int name = 55;
  static final int formContent = 31;
  static final int elseOpt = 19;
  static final int wsPair = 4;
  static final int settingsBlock_plus = 146;
  static final int interfaceContent_star = 125;
  static final int expr = 25;
  static final int openModifierOpt = 62;
  static final int replaceOption = 74;
  static final int getByKeyOption_plus = 119;
  static final int moveModifier_plus = 129;
  static final int openTarget_plus = 134;
  static final int stepOpt = 83;
  static final int externalTypeContent_plus = 109;
  static final int moveModifier = 54;
  static final int openTarget = 63;
  static final int withNameOpt = 93;
  static final int eventBlock_star = 102;
  static final int getByKeyOption = 38;
  static final int useTypeOpt = 91;
  static final int formGroupContent_star = 112;
  static final int functionParameter_star = 116;
  static final int fieldsOpt = 28;
  static final int initializerOpt = 44;
  static final int importDecl_plus = 124;
  static final int interfaceContent = 49;
  static final int replaceOption_star = 141;
  static final int expr_plus = 107;
  static final int forwardOption_star = 114;
  static final int stmt_plus = 150;
  ...
  static final int formContent_plus = 111;
  static final int typeNoName = 90;
  static final int ID_plus = 122;
  static final int literal = 52;
  static final int classContent_plus = 97;
  static final int simpleNameOpt = 81;
  static final int settingsBlock_star = 145;
  static final int defaultClauseOpt = 16;
  static final int showOption_plus = 148;
  static final int continueModifierOpt = 15;
  static final int privateAccessModifierOpt = 71;
  static final int file = 29;
  static final int arrayAccess = 6;
  static final int getByKeyOption_star = 118;
  static final int inparentOpt = 47;
  static final int ErrorNode = 3;
  static final int moveModifier_star = 128;
  static final int callReturnToOpt = 11;
  static final int addOption = 5;
  static final int getByPositionOption_plus = 121;
  static final int openTarget_star = 133;
  static final int namedType = 56;
  static final int externalTypeContent_star = 108;
  static final int timestampIntervalPrimitiveSpecOpt = 87;
  static final int part_plus = 136;
  static final int partSubTypeOpt = 66;
  static final int onException = 61;
  static final int deleteOption_plus = 99;
  static final int importDecl_star = 123;
  static final int stmt = 84;
  static final int expr_star = 106;
  static final int fieldAccess = 27;
  static final int stmt_star = 149;
  static final int enumerationField_plus = 101;
  static final int formContent_star = 110;
  static final int prepareOption_plus = 138;
  static final int intoClauseOpt = 50;
  static final int callOnExceptionOpt = 12;
  static final int classContent_star = 96;
  static final int externalTypeContent = 48;
  static final int executeTarget = 23;
  static final int inlineSQLStatement = 45;
  static final int showOption_star = 147;
  static final int onException_plus = 132;
  static final int programParameter_plus = 140;
  static final int structureContent_plus = 152;
  ...
  static final int structureContent = 86;
  static final int lvalue = 53;
  static final int getByPositionOption_star = 120;
  static final int setTarget_plus = 127;
  static final int parmConstOpt = 58;
  static final int part_star = 135;
  static final int executeOption = 22;
  static final int settingsBlockOpt = 79;
  ...
  static final int deleteOption_star = 98;
  static final int deleteOption = 17;
  static final int numericPrimitiveSpecOpt = 59;
  static final int executeOption_plus = 105;
  static final int bindOpt = 9;
  static final int implementsOpt = 42;
  static final int enumerationField_star = 100;
  static final int primary = 69;
  static final int prepareOption_star = 137;
  static final int addOption_plus = 95;
  static final int whenClause_plus = 154;
