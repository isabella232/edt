...
public class NodeTypes {
  ...
  /* non terminals */
  public  static final int getByPositionSource = 40;
  public  static final int onException_star = 131;
  public  static final int programParameter_star = 139;
  public  static final int structureContent_star = 151;
  public  static final int forwardTargetOpt = 34;
  public  static final int occursOpt = 60;
  public  static final int fromExprOpt = 35;
  public  static final int enumerationField = 20;
  public  static final int prepareOption = 68;
  public  static final int getByPositionOption = 39;
  public  static final int inlineSQLStatementOpt = 46;
  public  static final int foreachTarget = 30;
  public  static final int attrTypeOpt = 8;
  public  static final int exitModifierOpt = 24;
  public  static final int functionParameter = 37;
  public  static final int setting_plus = 144;
  public  static final int direction = 18;
  public  static final int staticAccessModifierOpt = 82;
  public  static final int executeOption_star = 104;
  public  static final int $START = 0;
  public  static final int connector = 2;
  public  static final int settingsBlock = 78;
  public  static final int returnsOpt = 75;
  public  static final int addOption_star = 94;
  public  static final int showOption = 80;
  public  static final int whenClause_star = 153;
  public  static final int extendsOpt = 26;
  public  static final int type = 89;
  public  static final int packageDeclarationOpt = 64;
  public  static final int interfaceContent_plus = 126;
  public  static final int programParameter = 72;
  public  static final int strItemDecl = 85;
  public  static final int transferTargetOpt = 88;
  public  static final int programParametersOpt = 73;
  public  static final int eventBlock = 21;
  public  static final int setting = 77;
  public  static final int eventBlock_plus = 103;
  public  static final int functionInvocation = 36;
  public  static final int setTarget = 76;
  public  static final int formGroupContent_plus = 113;
  public  static final int functionParameter_plus = 117;
  public  static final int setting_star = 143;
  public  static final int name_plus = 130;
  public  static final int whenClause = 92;
  public  static final int replaceOption_plus = 142;
  public  static final int part = 65;
  public  static final int forwardOption_plus = 115;
  public  static final int name = 55;
  public  static final int formContent = 31;
  public  static final int elseOpt = 19;
  public  static final int wsPair = 4;
  public  static final int settingsBlock_plus = 146;
  public  static final int interfaceContent_star = 125;
  public  static final int expr = 25;
  public  static final int openModifierOpt = 62;
  public  static final int replaceOption = 74;
  public  static final int getByKeyOption_plus = 119;
  public  static final int moveModifier_plus = 129;
  public  static final int openTarget_plus = 134;
  public  static final int stepOpt = 83;
  public  static final int externalTypeContent_plus = 109;
  public  static final int moveModifier = 54;
  public  static final int openTarget = 63;
  public  static final int withNameOpt = 93;
  public  static final int eventBlock_star = 102;
  public  static final int getByKeyOption = 38;
  public  static final int useTypeOpt = 91;
  public  static final int formGroupContent_star = 112;
  public  static final int functionParameter_star = 116;
  public  static final int fieldsOpt = 28;
  public  static final int initializerOpt = 44;
  public  static final int importDecl_plus = 124;
  public  static final int interfaceContent = 49;
  public  static final int replaceOption_star = 141;
  public  static final int expr_plus = 107;
  public  static final int forwardOption_star = 114;
  public  static final int stmt_plus = 150;
  public  static final int IDOpt = 41;
  public  static final int formGroupContent = 32;
  public  static final int UltraRoot = 1;
  public  static final int forwardOption = 33;
  public  static final int formContent_plus = 111;
  public  static final int typeNoName = 90;
  public  static final int ID_plus = 122;
  public  static final int literal = 52;
  public  static final int classContent_plus = 97;
  public  static final int simpleNameOpt = 81;
  public  static final int settingsBlock_star = 145;
  public  static final int defaultClauseOpt = 16;
  public  static final int showOption_plus = 148;
  public  static final int continueModifierOpt = 15;
  public  static final int privateAccessModifierOpt = 71;
  public  static final int file = 29;
  public  static final int arrayAccess = 6;
  public  static final int getByKeyOption_star = 118;
  public  static final int inparentOpt = 47;
  public  static final int ErrorNode = 3;
  public  static final int moveModifier_star = 128;
  public  static final int callReturnToOpt = 11;
  public  static final int addOption = 5;
  public  static final int getByPositionOption_plus = 121;
  public  static final int openTarget_star = 133;
  public  static final int namedType = 56;
  public  static final int externalTypeContent_star = 108;
  public  static final int timestampIntervalPrimitiveSpecOpt = 87;
  public  static final int part_plus = 136;
  public  static final int partSubTypeOpt = 66;
  public  static final int onException = 61;
  public  static final int deleteOption_plus = 99;
  public  static final int importDecl_star = 123;
  public  static final int stmt = 84;
  public  static final int expr_star = 106;
  public  static final int fieldAccess = 27;
  public  static final int stmt_star = 149;
  public  static final int enumerationField_plus = 101;
  public  static final int formContent_star = 110;
  public  static final int prepareOption_plus = 138;
  public  static final int intoClauseOpt = 50;
  public  static final int callOnExceptionOpt = 12;
  public  static final int classContent_star = 96;
  public  static final int externalTypeContent = 48;
  public  static final int executeTarget = 23;
  public  static final int inlineSQLStatement = 45;
  public  static final int showOption_star = 147;
  public  static final int onException_plus = 132;
  public  static final int programParameter_plus = 140;
  public  static final int structureContent_plus = 152;
  public  static final int assignment = 7;
  public  static final int passingRecordOpt = 67;
  public  static final int primaryNoNew = 70;
  public  static final int importDecl = 43;
  public  static final int structureContent = 86;
  public  static final int lvalue = 53;
  public  static final int getByPositionOption_star = 120;
  public  static final int setTarget_plus = 127;
  public  static final int parmConstOpt = 58;
  public  static final int part_star = 135;
  public  static final int executeOption = 22;
  public  static final int settingsBlockOpt = 79;
  public  static final int levelOpt = 51;
  public  static final int classContent = 14;
  public  static final int charPrimitiveSpecOpt = 13;
  public  static final int sqlNullableOpt = 57;
  public  static final int deleteOption_star = 98;
  public  static final int deleteOption = 17;
  public  static final int numericPrimitiveSpecOpt = 59;
  public  static final int executeOption_plus = 105;
  public  static final int bindOpt = 9;
  public  static final int implementsOpt = 42;
  public  static final int enumerationField_star = 100;
  public  static final int primary = 69;
  public  static final int prepareOption_star = 137;
  public  static final int addOption_plus = 95;
  public  static final int whenClause_plus = 154;
