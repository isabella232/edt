...
/**
 * UsingClause AST node type.
 *
 * @author Albert Ho
 * @author David Murray
 */
public class UsingClause extends Node {
	
	public static IOStatementClauseInfo INFO = new IOStatementClauseInfo() {
		public String getClauseKeyword() {
			return IEGLConstants.KEYWORD_USING;
		}
	...
	public UsingClause(List expr_plus, int startOffset, int endOffset) {
	...
	protected Object clone() throws CloneNotSupportedException {
		return new UsingClause(cloneList(expr_plus), getOffset(), getOffset() + getLength());
	}
}
