...
import org.eclipse.edt.compiler.binding.StructTextAnnotationTypeBinding;
...
public class StructTextValidator extends
	...
	protected String getName() {
		return StructTextAnnotationTypeBinding.caseSensitiveName;
	}

	@Override
	protected String getInternedName() {
		return StructTextAnnotationTypeBinding.name;
	}
