...
import org.eclipse.edt.compiler.binding.StructTimestampAnnotationTypeBinding;
...
public class StructTimestampValidator extends
	...
	protected String getName() {
		return StructTimestampAnnotationTypeBinding.caseSensitiveName;
	}

	@Override
	protected String getInternedName() {
		return StructTimestampAnnotationTypeBinding.name;
	}
