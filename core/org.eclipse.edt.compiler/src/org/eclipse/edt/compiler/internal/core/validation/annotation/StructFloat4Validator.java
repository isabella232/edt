...
import org.eclipse.edt.compiler.binding.StructFloat4AnnotationTypeBinding;
...
public class StructFloat4Validator extends AbstractStructParameterAnnotaionValidator implements IAnnotationValidationRule {
	...
	protected String getName() {
		return StructFloat4AnnotationTypeBinding.caseSensitiveName;
	}
	
	@Override
	protected String getInternedName() {
		return StructFloat4AnnotationTypeBinding.name;
	}
}
