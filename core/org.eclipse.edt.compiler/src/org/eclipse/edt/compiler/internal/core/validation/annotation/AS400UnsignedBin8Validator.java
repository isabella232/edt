...
import org.eclipse.edt.compiler.binding.AS400UnsignedBin8AnnotationTypeBinding;
import org.eclipse.edt.compiler.binding.Binding;
import org.eclipse.edt.compiler.binding.ITypeBinding;
import org.eclipse.edt.compiler.binding.PrimitiveTypeBinding;
import org.eclipse.edt.compiler.core.ast.Primitive;

public class AS400UnsignedBin8Validator extends AbstractAS400ParameterAnnotaionValidator implements IAnnotationValidationRule {
	
	@Override
	protected String getName() {
		return AS400UnsignedBin8AnnotationTypeBinding.caseSensitiveName;
	}
	
	@Override
	protected String getInternedName() {
		return AS400UnsignedBin8AnnotationTypeBinding.name;
	}
