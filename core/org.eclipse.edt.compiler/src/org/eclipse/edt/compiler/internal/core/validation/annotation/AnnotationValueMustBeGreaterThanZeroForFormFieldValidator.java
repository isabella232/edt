 ...
 * @author demurray
 */
public class AnnotationValueMustBeGreaterThanZeroForFormFieldValidator extends FieldContentValidationAnnotationTypeBinding {
	
	String canonicalAnnotationName;
	IAnnotationTypeBinding annotationTypeBinding;
	
	public AnnotationValueMustBeGreaterThanZeroForFormFieldValidator(String canonicalAnnotationName, IAnnotationTypeBinding annotationTypeBinding) {
		super(InternUtil.internCaseSensitive("AnnotationValueMustBeGreaterThenZeroForFormFieldValidator"));
		...
		if(annotationBinding != null) {
			...
			if(!valid) {
				problemRequestor.acceptProblem(
					errorNode,
					IProblemRequestor.INVALID_FORM_FIELD_POSITIVE_INTEGER_PROPERTY_VALUE,
					new String[] {
