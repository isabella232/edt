...
//	Contants used when creating markers
	...
	public static int DLICALLKIND_AIBTDLI = 1;
	public static int DLICALLKIND_CBLTDLI = 2;
	
	public static int PCBKIND_TP = 1;
	public static int PCBKIND_DB = 2;
	public static int PCBKIND_GSAM = 3;
