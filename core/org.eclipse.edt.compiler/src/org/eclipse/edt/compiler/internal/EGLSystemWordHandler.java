...
public class EGLSystemWordHandler {
	...
	public static final String consoleLibrary = IEGLConstants.KEYWORD_CONSOLELIB;
	public static final String reportLibrary = IEGLConstants.KEYWORD_REPORTLIB;
	public static final String lobLibrary = IEGLConstants.KEYWORD_LOBLIB;
	public static final String vgVariablesLibrary = IEGLConstants.KEYWORD_VGVAR; 	
	public static final String vgLibrary = IEGLConstants.KEYWORD_VGLIB; 
	public static final String converseVariablesLibrary = IEGLConstants.KEYWORD_CONVERSEVAR;  
	public static final String javaLibrary = IEGLConstants.KEYWORD_JAVALIB;  
	public static final String dateTimeLibrary = IEGLConstants.KEYWORD_DATETIMELIB;  
	public static final String j2eeLibrary = IEGLConstants.KEYWORD_J2EELIB; 
	public static final String converseLibrary = IEGLConstants.KEYWORD_CONVERSELIB; 	
	public static final String dliVariablesLibrary = IEGLConstants.KEYWORD_DLIVAR; 
	public static final String dliLibrary = IEGLConstants.KEYWORD_DLILIB;
	...
	static {
		...
		systemWords.put(IEGLConstants.KEYWORD_CONSOLELIB,consoleLibWords);
		systemWords.put(IEGLConstants.KEYWORD_REPORTLIB,reportLibWords);
		systemWords.put(IEGLConstants.KEYWORD_LOBLIB,lobLibWords);
		systemWords.put(IEGLConstants.KEYWORD_VGLIB,vgLibWords);
		systemWords.put(IEGLConstants.KEYWORD_VGVAR,vgVarWords);
		systemWords.put(IEGLConstants.KEYWORD_JAVALIB,javaLibWords);
		systemWords.put(IEGLConstants.KEYWORD_DATETIMELIB,dateTimeLibWords);
		systemWords.put(IEGLConstants.KEYWORD_J2EELIB,j2eeLibWords);
		systemWords.put(IEGLConstants.KEYWORD_CONVERSEVAR,converseVarWords);
		systemWords.put(IEGLConstants.KEYWORD_CONVERSELIB,converseLibWords);		
		...
		systemWords.put(IEGLConstants.KEYWORD_DLIVAR,dliVarWords);
		systemWords.put(IEGLConstants.KEYWORD_DLILIB,dliLibWords);
		...
		// blob functions (6.0.0.1)	
		//these can not be standalone.  must be after a blob.
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_ATTACHBLOBTOFILE, new EGLSystemFunctionWord("attachBlobToFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AttachBlobToFile, lobLibrary, null, 0, new String[] {"blobVariable", "fileName"}, new String[] {IEGLConstants.BLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_GETBLOBLEN, new EGLSystemFunctionWord("getBlobLen", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetBlobLen, lobLibrary, IEGLConstants.BIGINT_STRING, 18, new String[] {"blobVariable"}, new String[] {IEGLConstants.BLOB_STRING}, new int[] {IN}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 		
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_TRUNCATEBLOB, new EGLSystemFunctionWord("truncateBlob", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_TruncateBlob, lobLibrary, null, 0, new String[] {"blobVariable", "length"}, new String[] {IEGLConstants.BLOB_STRING, IEGLConstants.BIGINT_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_LOADBLOBFROMFILE, new EGLSystemFunctionWord("loadBlobFromFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_LoadBlobFromFile, lobLibrary, null, 0, new String[] {"blobVariable", "fileName"}, new String[] {IEGLConstants.BLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_UPDATEBLOBTOFILE, new EGLSystemFunctionWord("updateBlobToFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_UpdateBlobToFile, lobLibrary, null, 0, new String[] {"blobVariable", "fileName"}, new String[] {IEGLConstants.BLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_FREEBLOB, new EGLSystemFunctionWord("freeBlob", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_FreeBlob, lobLibrary, null, 0, new String[] {"blobVariable"}, new String[] {IEGLConstants.BLOB_STRING}, new int[] {INOUT}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 

		// clob functions (6.0.0.1)
		//these can not be standalone.  must be after a clob.
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_ATTACHCLOBTOFILE, new EGLSystemFunctionWord("attachClobToFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AttachClobToFile, lobLibrary, null, 0, new String[] {"clobVariable", "fileName"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_GETCLOBLEN, new EGLSystemFunctionWord("getClobLen", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetClobLen, lobLibrary, IEGLConstants.BIGINT_STRING, 18, new String[] {"clobVariable"}, new String[] {IEGLConstants.CLOB_STRING}, new int[] {IN}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_GETSUBSTRFROMCLOB, new EGLSystemFunctionWord("getSubStrFromClob", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetSubStrFromClob, lobLibrary, IEGLConstants.STRING_STRING, 0, new String[] {"clobVariable", "position", "length"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.BIGINT_STRING, IEGLConstants.BIGINT_STRING}, new int[] {IN, IN, IN}, new int[] {3} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_GETSTRFROMCLOB, new EGLSystemFunctionWord("getStrFromClob", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetStrFromClob, lobLibrary, IEGLConstants.STRING_STRING, 0, new String[] {"clobVariable" }, new String[] {IEGLConstants.CLOB_STRING}, new int[] {IN}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_SETCLOBFROMSTRINGATPOSITION, new EGLSystemFunctionWord("setClobFromStringAtPosition", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_SetClobFromStringAtPosition, lobLibrary, null, 0, new String[] {"clobVariable", "position","string"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.BIGINT_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN, IN}, new int[] {3} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_SETCLOBFROMSTRING, new EGLSystemFunctionWord("setClobFromString", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_SetClobFromString, lobLibrary, null, 0, new String[] {"clobVariable", "string"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.STRING_STRING }, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 		
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_TRUNCATECLOB, new EGLSystemFunctionWord("truncateClob", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_TruncateClob, lobLibrary, null, 0, new String[] {"clobVariable", "length"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.BIGINT_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_LOADCLOBFROMFILE, new EGLSystemFunctionWord("loadClobFromFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_LoadClobFromFile, lobLibrary, null, 0, new String[] {"clobVariable", "fileName"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_UPDATECLOBTOFILE, new EGLSystemFunctionWord("updateClobToFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_UpdateClobToFile, lobLibrary, null, 0, new String[] {"clobVariable", "fileName"}, new String[] {IEGLConstants.CLOB_STRING, IEGLConstants.STRING_STRING}, new int[] {INOUT, IN}, new int[] {2} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_FREECLOB, new EGLSystemFunctionWord("freeClob", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_FreeClob, lobLibrary, null, 0, new String[] {"clobVariable"}, new String[] {IEGLConstants.CLOB_STRING}, new int[] {INOUT}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_ATTACHBLOBTOTEMPFILE, new EGLSystemFunctionWord("attachBlobToTempFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AttachBlobToTempFile, lobLibrary, null, 0, new String[] {"blobVariable"}, new String[] {IEGLConstants.BLOB_STRING}, new int[] {INOUT}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 
		lobLibWords.put(IEGLConstants.SYSTEM_WORD_ATTACHCLOBTOTEMPFILE, new EGLSystemFunctionWord("attachClobToTempFile", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AttachClobToTempFile, lobLibrary, null, 0, new String[] {"clobVariable"}, new String[] {IEGLConstants.CLOB_STRING}, new int[] {INOUT}, new int[] {1} )); //$NON-NLS-1$ //$NON-NLS-2$ 
...
//		sysVarWords.put(IEGLConstants.SYSTEM_WORD_HANDLEHARDDLIERRORS, new EGLSystemVariable("handleHardDliErrors", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_VAGEN_COMPATIBILITY, IEGLConstants.Special_Function_HandleHardDliErrors, IEGLConstants.BIN_STRING, 9)); //$NON-NLS-1$
		...
		//reportLib Functions
		reportLibWords.put(IEGLConstants.SYSTEM_WORD_FILLREPORT, new EGLSystemFunctionWord("fillReport", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_FillReport, reportLibrary, null, 0, new String[] {"report", "source"}, new String[] {IEGLConstants.EGL_REPORTS_JASPER_REPORT_STRING, IEGLConstants.EGL_REPORTS_JASPER_DATASOURCE_STRING}, new int[] {INOUT, IN}, new int[] {2})); //$NON-NLS-1$ //$NON-NLS-2$ 
		reportLibWords.put(IEGLConstants.SYSTEM_WORD_EXPORTREPORT, new EGLSystemFunctionWord("exportReport", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ExportReport, reportLibrary, null, 0, new String[] {"report", "format"}, new String[] {IEGLConstants.EGL_REPORTS_JASPER_REPORT_STRING, IEGLConstants.EGL_REPORTS_JASPER_EXPORTFORMAT_STRING}, new int[] {INOUT, IN}, new int[] {2})); //$NON-NLS-1$ //$NON-NLS-2$ 
		reportLibWords.put(IEGLConstants.SYSTEM_WORD_ADDREPORTPARAMETER, new EGLSystemFunctionWord("addReportParameter", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AddReportParameter, reportLibrary, null, 0, new String[] {"report", "parameter", "value"}, new String[] {IEGLConstants.EGL_REPORTS_JASPER_REPORT_STRING, IEGLConstants.STRING_STRING, IEGLConstants.ANY_STRING}, new int[] {INOUT, IN, IN}, new int[] {3})); //$NON-NLS-1$ //$NON-NLS-2$ 
		reportLibWords.put(IEGLConstants.SYSTEM_WORD_RESETREPORTPARAMETERS, new EGLSystemFunctionWord("resetReportParameters", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ResetReportParameters, reportLibrary, null, 0, new String[] {"report"}, new String[] {IEGLConstants.EGL_REPORTS_JASPER_REPORT_STRING}, new int[] {INOUT}, new int[] {1})); //$NON-NLS-1$ //$NON-NLS-2$ 

		
		//CONSOLE UI Variables
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_ACCEPT, new EGLSystemVariable("key_accept", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Accept, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_DELETELINE, new EGLSystemVariable("key_deleteLine", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_DeleteLine, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_INSERTLINE, new EGLSystemVariable("key_insertLine", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_InsertLine, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_PAGEDOWN, new EGLSystemVariable("key_pageDown", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Pagedown, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_PAGEUP, new EGLSystemVariable("key_pageUp", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Pageup, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_HELP, new EGLSystemVariable("key_help", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Help, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_INTERRUPT, new EGLSystemVariable("key_interrupt", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Interrupt, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_KEY_QUIT, new EGLSystemVariable("key_quit", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Key_Quit, IEGLConstants.CHAR_STRING, 32, consoleLibrary)); //$NON-NLS-1$
//?????

		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ACTIVEFORM, new EGLSystemVariable("activeForm", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_ActiveForm, IEGLConstants.ANY_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ACTIVEWINDOW, new EGLSystemVariable("activeWindow", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_ActiveWindow, IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ERRORWINDOWVISIBLE, new EGLSystemVariable("errorWindowVisible", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_ErrorWindowVisible, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ERRORWINDOW, new EGLSystemVariable("errorWindow", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_ErrorWindow, IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_COMMENTLINE, new EGLSystemVariable("commentLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_CommentLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ERRORLINE, new EGLSystemVariable("errorLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_ErrorLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_FORMLINE, new EGLSystemVariable("formLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_FormLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_MENULINE, new EGLSystemVariable("menuLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_MenuLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_MESSAGELINE, new EGLSystemVariable("messageLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_MessageLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_PROMPTLINE, new EGLSystemVariable("promptLine", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_PromptLine, IEGLConstants.INT_STRING, 8, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SCREEN, new EGLSystemVariable("screen", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_Screen, IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_INTERRUPTREQUESTED, new EGLSystemVariable("interruptRequested", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_InterruptRequested, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_QUITREQUESTED, new EGLSystemVariable("quitRequested", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_QuitRequested, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_MESSAGERESOURCE, new EGLSystemVariable("messageResource", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_MessageResource, IEGLConstants.CHAR_STRING, 255, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURSORWRAP, new EGLSystemVariable("cursorWrap", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_CursorWrap, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DEFINEDFIELDORDER, new EGLSystemVariable("definedFieldOrder", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_DefinedFieldOrder, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DEFERINTERRUPT, new EGLSystemVariable("deferInterrupt", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_DeferInterrupt, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DEFERQUIT, new EGLSystemVariable("deferQuit", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_DeferQuit, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SQLINTERRUPT, new EGLSystemVariable("sqlInterrupt", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_SQLInterrupt, IEGLConstants.EGL_CONSOLE_UI_BOOLEAN_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DEFAULTDISPLAYATTRIBUTES, new EGLSystemVariable("defaultDisplayAttributes", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_DefaultDisplayAttributes, IEGLConstants.EGL_CONSOLE_UI_PRESENTATIONATTRIBUTES_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DEFAULTINPUTATTRIBUTES, new EGLSystemVariable("defaultInputAttributes", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_DefaultInputAttributes, IEGLConstants.EGL_CONSOLE_UI_PRESENTATIONATTRIBUTES_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURRENTDISPLAYATTRS, new EGLSystemVariable("currentDisplayAttrs", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_CurrentDisplayAttributes, IEGLConstants.EGL_CONSOLE_UI_PRESENTATIONATTRIBUTES_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURRENTROWATTRS, new EGLSystemVariable("currentRowAttrs", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_CurrentRowAttributes, IEGLConstants.EGL_CONSOLE_UI_PRESENTATIONATTRIBUTES_STRING, 0, consoleLibrary)); //$NON-NLS-1$
		
		//console UI Functions
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYLINEMODE, new EGLSystemFunctionWord("displayLineMode", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayLineMode, consoleLibrary, null, 0, new String[] {"displayText"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_PROMPTLINEMODE, new EGLSystemFunctionWord("promptLineMode", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_PromptLineMode, consoleLibrary, IEGLConstants.STRING_STRING, 0, new String[] {"displayText"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ACTIVATEWINDOW, new EGLSystemFunctionWord("activateWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ActivateWindow, consoleLibrary, null, 0, new String[] {"window"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ACTIVATEWINDOWBYNAME, new EGLSystemFunctionWord("activateWindowByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ActivateWindowByName, consoleLibrary, null, 0, new String[] {"windowName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARACTIVEWINDOW, new EGLSystemFunctionWord("clearActiveWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearActiveWindow, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARWINDOW, new EGLSystemFunctionWord("clearWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearWindow, consoleLibrary, null, 0, new String[] {"window"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARWINDOWBYNAME, new EGLSystemFunctionWord("clearWindowByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearWindowByName, consoleLibrary, null, 0, new String[] {"windowName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLOSEACTIVEWINDOW, new EGLSystemFunctionWord("closeActiveWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CloseActiveWindow, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLOSEWINDOW, new EGLSystemFunctionWord("closeWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CloseWindow, consoleLibrary, null, 0, new String[] {"window"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING}, new int[] {INOUT}, new int[] {1}	)); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLOSEWINDOWBYNAME, new EGLSystemFunctionWord("closeWindowByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CloseWindowByName, consoleLibrary, null, 0, new String[] {"windowName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] {1})); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DRAWBOX, new EGLSystemFunctionWord("drawBox", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DrawBox, consoleLibrary, null, 0, new String[] {"row", "column", "depth", "width"}, new String[] {IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING}, new int[] {IN, IN, IN, IN}, new int[] { 4 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DRAWBOXWITHCOLOR, new EGLSystemFunctionWord("drawBoxWithColor", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DrawBoxWithColor, consoleLibrary, null, 0, new String[] {"row", "column", "depth", "width", "colorKind"}, new String[] {IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, IEGLConstants.EGL_CONSOLE_UI_COLORKIND_STRING}, new int[] {IN, IN, IN, IN, IN}, new int[] { 5 } )); //$NON-NLS-1$ //$NON-NLS-2$  
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYATLINE, new EGLSystemFunctionWord("displayAtLine", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayAtLine, consoleLibrary, null, 0, new String[] {"text", "row"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.INT_STRING}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYATPOSITION, new EGLSystemFunctionWord("displayAtPosition", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayAtPosition, consoleLibrary, null, 0, new String[] {"text", "row", "column"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING}, new int[] {IN, IN, IN}, new int[] { 3 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYMESSAGE, new EGLSystemFunctionWord("displayMessage", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayMessage, consoleLibrary, null, 0, new String[] {"messageText"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYERROR, new EGLSystemFunctionWord("displayError", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayError, consoleLibrary, null, 0, new String[] {"errorText"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 							
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_HIDEERRORWINDOW, new EGLSystemFunctionWord("hideErrorWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_HideErrorWindow, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 				
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_OPENWINDOW, new EGLSystemFunctionWord("openWindow", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_OpenWindow, consoleLibrary, null, 0, new String[] {"window"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_OPENWINDOWBYNAME, new EGLSystemFunctionWord("openWindowByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_OpenWindowByName, consoleLibrary, null, 0, new String[] {"windowName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_OPENWINDOWWITHFORM, new EGLSystemFunctionWord("openWindowWithForm", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_OpenWindowWithForm, consoleLibrary, null, 0, new String[] {"window", "consoleForm"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOW_STRING, IEGLConstants.EGL_CONSOLE_UI_CONSOLEFORM_STRING}, new int[] {INOUT, INOUT}, new int[] {2})); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_OPENWINDOWWITHFORMBYNAME, new EGLSystemFunctionWord("openWindowWithFormByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_OpenWindowWithFormByName, consoleLibrary, null, 0, new String[] {"windowName", "consoleFormName"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARACTIVEFORM, new EGLSystemFunctionWord("clearActiveForm", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearActiveForm, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARFORM, new EGLSystemFunctionWord("clearForm", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearForm, consoleLibrary, null, 0, new String[] {"consoleForm"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFORM_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARFIELDS, new EGLSystemFunctionWord("clearFields", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearFields, consoleLibrary, null, 0, new String[] {"consoleFields"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFIELD_STRING}, new int[] {INOUT}, new int[] { ARG_COUNT_N_OR_MORE, 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARFIELDSBYNAME, new EGLSystemFunctionWord("clearFieldsByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearFieldsByName, consoleLibrary, null, 0, new String[] {"consoleFieldNames"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { ARG_COUNT_N_OR_MORE, 1})); //$NON-NLS-1$ //$NON-NLS-2$ 

		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYFORM, new EGLSystemFunctionWord("displayForm", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayForm, consoleLibrary, null, 0, new String[] {"consoleForm"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFORM_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$  
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYFORMBYNAME, new EGLSystemFunctionWord("displayFormByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayFormByName, consoleLibrary, null, 0, new String[] {"consoleFormName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1})); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYFIELDS, new EGLSystemFunctionWord("displayFields", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayFields, consoleLibrary, null, 0, new String[] {"consoleFields"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFIELD_STRING}, new int[] {IN}, new int[] { ARG_COUNT_N_OR_MORE, 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYFIELDSBYNAME, new EGLSystemFunctionWord("displayFieldsByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayFieldsByName, consoleLibrary, null, 0, new String[] {"consoleFieldNames"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { ARG_COUNT_N_OR_MORE, 1})); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GOTOFIELD, new EGLSystemFunctionWord("gotoField", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_GotoField, consoleLibrary, null, 0, new String[] {"consoleField"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFIELD_STRING}, new int[] {INOUT}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GOTOFIELDBYNAME, new EGLSystemFunctionWord("gotoFieldByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_GotoFieldByName, consoleLibrary, null, 0, new String[] {"consoleFieldName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$  
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_NEXTFIELD, new EGLSystemFunctionWord("nextField", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_NextField, consoleLibrary, null, 0, new String[0] , new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_PREVIOUSFIELD, new EGLSystemFunctionWord("previousField", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_PreviousField, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ISCURRENTFIELD, new EGLSystemFunctionWord("isCurrentField", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsCurrentField, consoleLibrary, IEGLConstants.BOOLEAN_STRING, 9, new String[] {"consoleField"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFIELD_STRING}, new int[] {INOUT}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ISCURRENTFIELDBYNAME, new EGLSystemFunctionWord("isCurrentFieldByName", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsCurrentFieldByName, consoleLibrary, IEGLConstants.BOOLEAN_STRING, 9, new String[] {"consoleFieldName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ISFIELDMODIFIED, new EGLSystemFunctionWord("isFieldModified", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsFieldModified, consoleLibrary, IEGLConstants.BOOLEAN_STRING, 9, new String[] {"consoleField"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_CONSOLEFIELD_STRING}, new int[] {INOUT}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 				
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_ISFIELDMODIFIEDBYNAME, new EGLSystemFunctionWord("isFieldModifiedByName", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsFieldModifiedByName, consoleLibrary, IEGLConstants.BOOLEAN_STRING, 9, new String[] {"consoleFieldName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GETKEY, new EGLSystemFunctionWord("getKey", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetKey, consoleLibrary, IEGLConstants.INT_STRING, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GETKEYCODE, new EGLSystemFunctionWord("getKeyCode", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetKeyCode, consoleLibrary, IEGLConstants.INT_STRING, 9, new String[] {"key"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GETKEYNAME, new EGLSystemFunctionWord("getKeyName", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetKeyName, consoleLibrary, IEGLConstants.STRING_STRING, 0, new String[] {"key"}, new String[] {IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_LASTKEYTYPED, new EGLSystemFunctionWord("lastKeyTyped", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_LastKeyTyped, consoleLibrary, IEGLConstants.INT_STRING, 9, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CANCELARRAYDELETE, new EGLSystemFunctionWord("cancelArrayDelete", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CancelArrayDelete, consoleLibrary, null, 0 , new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CANCELARRAYINSERT, new EGLSystemFunctionWord("cancelArrayInsert", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CancelArrayInsert, consoleLibrary, null, 0 , new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURRENTARRAYSCREENLINE, new EGLSystemFunctionWord("currentArrayScreenLine", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_CurrentArrayScreenLine, consoleLibrary, IEGLConstants.INT_STRING, 9, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURRENTARRAYDATALINE, new EGLSystemFunctionWord("currentArrayDataLine", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_CurrentArrayDataLine, consoleLibrary, IEGLConstants.INT_STRING, 9, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SCROLLDOWNPAGE, new EGLSystemFunctionWord("scrollDownPage", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ScrollDownPage, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SCROLLDOWNLINES, new EGLSystemFunctionWord("scrollDownLines", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ScrollDownLines, consoleLibrary, null, 0, new String[] {"lines"}, new String[]{IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ 		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SCROLLUPPAGE, new EGLSystemFunctionWord("scrollUpPage", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ScrollUpPage, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SCROLLUPLINES, new EGLSystemFunctionWord("scrollUpLines", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ScrollUpLines, consoleLibrary, null, 0, new String[] {"lines"}, new String[] {IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SETARRAYLINE, new EGLSystemFunctionWord("setArrayLine", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_SetArrayLine, consoleLibrary, null, 0, new String[] {"lines"}, new String[] {IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SETCURRENTARRAYCOUNT, new EGLSystemFunctionWord("setCurrentArrayCount", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_SetCurrentArrayCount, consoleLibrary, null, 0, new String[] {"lines"}, new String[] {IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ 
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SHOWHELP, new EGLSystemFunctionWord("showHelp", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ShowHelp, consoleLibrary, null, 0, new String[] {"helpMessage"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		

		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_HIDEMENUITEM, new EGLSystemFunctionWord("hideMenuItem", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_HideMenuItem, consoleLibrary, null, 0, new String[] {"menuItem"}, new String[] {IEGLConstants.MENU_ITEM_STRING }, new int[] {INOUT}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_HIDEMENUITEMBYNAME, new EGLSystemFunctionWord("hideMenuItemByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_HideMenuItemByName, consoleLibrary, null, 0, new String[] {"menuItemName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GOTOMENUITEM, new EGLSystemFunctionWord("gotoMenuItem", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_GotoMenuItem, consoleLibrary, null, 0, new String[] {"menuItem"}, new String[] {IEGLConstants.MENU_ITEM_STRING }, new int[] {INOUT}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_GOTOMENUITEMBYNAME, new EGLSystemFunctionWord("gotoMenuItemByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_GotoMenuItemByName, consoleLibrary, null, 0, new String[] {"menuItemName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SHOWMENUITEM, new EGLSystemFunctionWord("showMenuItem", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ShowMenuItem, consoleLibrary, null, 0, new String[] {"menuItem"}, new String[] {IEGLConstants.MENU_ITEM_STRING }, new int[] {INOUT}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SHOWMENUITEMBYNAME, new EGLSystemFunctionWord("showMenuItemByName", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ShowMenuItemByName, consoleLibrary, null, 0, new String[] {"menuItemName"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_CURRENTARRAYCOUNT, new EGLSystemFunctionWord("currentArrayCount", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_CurrentArrayCount, consoleLibrary, IEGLConstants.INT_STRING, 0, new String[0], new String[0], new int[0], new int[] { 0 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_SHOWALLMENUITEMS, new EGLSystemFunctionWord("showAllMenuItems", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ShowAllMenuItems, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 } )); //$NON-NLS-1$ //$NON-NLS-2$
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_HIDEALLMENUITEMS, new EGLSystemFunctionWord("hideAllMenuItems", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_HideAllMenuItems, consoleLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 } )); //$NON-NLS-1$ //$NON-NLS-2$
		
		consoleLibWords.put(IEGLConstants.SYSTEM_WORD_UPDATEWINDOWATTRIBUTES, new EGLSystemFunctionWord("updateWindowAttributes", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_UpdateWindowAttributes, consoleLibrary, null, 0, new String[] {"windowAttributes"}, new String[] {IEGLConstants.EGL_CONSOLE_UI_WINDOWATTRIBUTEKIND_STRING}, new int[] {IN}, new int[] { ARG_COUNT_N_OR_MORE, 1})); //$NON-NLS-1$ //$NON-NLS-2$
		
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTGREGORIANDATE, new EGLSystemVariable("currentGregorianDate", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentGregorianDate, IEGLConstants.NUM_STRING, 8, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTFORMATTEDGREGORIANDATE, new EGLSystemVariable("currentFormattedGregorianDate", SYSTEM_WORD_CHARACTER | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentFormattedGregorianDate, IEGLConstants.CHAR_STRING, 10, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTJULIANDATE, new EGLSystemVariable("currentJulianDate", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentJulianDate, IEGLConstants.NUM_STRING, 7, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTFORMATTEDJULIANDATE, new EGLSystemVariable("currentFormattedJulianDate", SYSTEM_WORD_CHARACTER | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentFormattedJulianDate, IEGLConstants.CHAR_STRING, 8, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTSHORTGREGORIANDATE, new EGLSystemVariable("currentShortGregorianDate", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentShortGregorianDate, IEGLConstants.NUM_STRING, 6, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTSHORTJULIANDATE, new EGLSystemVariable("currentShortJulianDate", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentShortJulianDate, IEGLConstants.NUM_STRING, 5, vgVariablesLibrary));
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_CURRENTFORMATTEDTIME, new EGLSystemVariable("currentFormattedTime", SYSTEM_WORD_CHARACTER | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_CurrentFormattedTime, IEGLConstants.CHAR_STRING, 8, vgVariablesLibrary));		
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_HANDLEHARDIOERRORS, new EGLSystemVariable("handleHardIOErrors", SYSTEM_WORD_NUMERIC,IEGLConstants.Special_Function_HandleHardIOErrors, IEGLConstants.NUM_STRING, 1, vgVariablesLibrary)); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_HANDLEOVERFLOW, new EGLSystemVariable("handleOverflow", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_HandleOverflow, IEGLConstants.NUM_STRING, 1, vgVariablesLibrary)); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_HANDLESYSLIBRARYERRORS, new EGLSystemVariable("handleSysLibraryErrors", SYSTEM_WORD_NUMERIC | SYSTEM_WORD_VAGEN_COMPATIBILITY, IEGLConstants.Special_Function_HandleSysLibErrors, IEGLConstants.NUM_STRING, 1, vgVariablesLibrary )); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_MQCONDITIONCODE, new EGLSystemVariable("mqConditionCode", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_MQConditionCode, IEGLConstants.CHAR_STRING, 2, vgVariablesLibrary)); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SQLERRD, new EGLSystemVariable("sqlerrd", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_SqlErrd, IEGLConstants.BIN_STRING, 9, vgVariablesLibrary, 6)); //$NON-NLS-1$		
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SQLERRMC, new EGLSystemVariable("sqlerrmc", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_SqlErrmc, IEGLConstants.CHAR_STRING, 70, vgVariablesLibrary)); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SQLWARN, new EGLSystemVariable("sqlwarn", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_SqlWarn, IEGLConstants.CHAR_STRING, 1, vgVariablesLibrary, 11)); //$NON-NLS-1$		
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SQLISOLATIONLEVEL, new EGLSystemVariable("sqlIsolationLevel", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_SqlIsolationLevel, IEGLConstants.NUM_STRING, 1, vgVariablesLibrary)); //$NON-NLS-1$
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SYSTEMGREGORIANDATEFORMAT, new EGLSystemVariable("systemGregorianDateFormat", SYSTEM_WORD_CHARACTER | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_SystemGregorianDateFormat, IEGLConstants.STRING_STRING, 0, vgVariablesLibrary)); //$NON-NLS-1$		
		vgVarWords.put(IEGLConstants.SYSTEM_WORD_SYSTEMJULIANDATEFORMAT, new EGLSystemVariable("systemJulianDateFormat", SYSTEM_WORD_CHARACTER | SYSTEM_WORD_READ_ONLY, IEGLConstants.Special_Function_SystemJulianDateFormat, IEGLConstants.STRING_STRING, 0, vgVariablesLibrary)); //$NON-NLS-1$
		
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_DBNAME, new EGLSystemVariable("dbName", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_DBName, IEGLConstants.CHAR_STRING, 8, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_SEGMENTLEVEL, new EGLSystemVariable("segmentLevel", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_SegmentLevel, IEGLConstants.NUM_STRING, 2, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_STATUSCODE, new EGLSystemVariable("statusCode", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_StatusCode, IEGLConstants.CHAR_STRING, 4, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_PROCOPTIONS, new EGLSystemVariable("procOptions", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_ProcOptions, IEGLConstants.CHAR_STRING, 4, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_SEGMENTNAME, new EGLSystemVariable("segmentName", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_SegmentName, IEGLConstants.CHAR_STRING, 8, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_KEYAREALEN, new EGLSystemVariable("keyAreaLen", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_KeyAreaLen, IEGLConstants.INT_STRING, 8, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_KEYAREA, new EGLSystemVariable("keyArea", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_KeyArea, IEGLConstants.CHAR_STRING, 3825, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_HANDLEHARDDLIERRORS, new EGLSystemVariable("handleHardDLIErrors", SYSTEM_WORD_NUMERIC, IEGLConstants.Special_Function_HandleHardDLIErrors, IEGLConstants.SMALLINT_STRING, 2, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_NUMSENSITIVESEGS, new EGLSystemVariable("numSensitiveSegs", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_NumSensitiveSegs, IEGLConstants.INT_STRING, 8, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_CICSERROR, new EGLSystemVariable("cicsError", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_CICSError, IEGLConstants.CHAR_STRING, 2, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_CICSCONDITION, new EGLSystemVariable("cicsCondition", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_CICSCondition, IEGLConstants.CHAR_STRING, 8, dliVariablesLibrary)); //$NON-NLS-1$
		dliVarWords.put( IEGLConstants.SYSTEM_WORD_CICSRESTART, new EGLSystemVariable("cicsRestart", SYSTEM_WORD_CHARACTER, IEGLConstants.Special_Function_CICSRestart, IEGLConstants.NUM_STRING, 1, dliVariablesLibrary)); //$NON-NLS-1$
		
		dliLibWords.put( IEGLConstants.SYSTEM_WORD_EGLTDLI, new EGLSystemFunctionWord( "EGLTDLI", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_EGLTDLI, dliLibrary, null, 0, new String[] {"func", "pcb", "parm"}, new String[] {IEGLConstants.CHAR4_STRING, recordSystemFunction, IEGLConstants.ANY_STRING}, new int[] {IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 2 } )); //$NON-NLS-1$ //$NON-NLS-2$		
		dliLibWords.put( IEGLConstants.SYSTEM_WORD_AIBTDLI, new EGLSystemFunctionWord( "AIBTDLI", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_AIBTDLI, dliLibrary, null, 0, new String[] {"func", "pcbName", "parm"}, new String[] {IEGLConstants.CHAR4_STRING, IEGLConstants.STRING_STRING, IEGLConstants.ANY_STRING}, new int[] {IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 2 } )); //$NON-NLS-1$ //$NON-NLS-2$
		dliLibWords.put( IEGLConstants.SYSTEM_WORD_PSBDATA, new EGLSystemVariable("psbData", SYSTEM_WORD_NAMEDTYPE, IEGLConstants.Special_Function_PSBData, IEGLConstants.PSBDATARECORD_STRING, 0, dliLibrary)); //$NON-NLS-1$

		vgLibWords.put( IEGLConstants.SYSTEM_WORD_VGTDLI, new EGLSystemFunctionWord( "VGTDLI", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_VGTDLI, vgLibrary, null, 0, new String[] {"func", "pcbIndex", "parm"}, new String[] {IEGLConstants.CHAR4_STRING, IEGLConstants.NUMBER_STRING, IEGLConstants.ANY_STRING}, new int[] {IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 2 } )); //$NON-NLS-1$ //$NON-NLS-2$
		vgLibWords.put(IEGLConstants.SYSTEM_WORD_GETVAGSYSTYPE, new EGLSystemFunctionWord("getVAGSysType", SYSTEM_WORD_RETURNS | SYSTEM_WORD_VAGEN_COMPATIBILITY, IEGLConstants.Special_Function_GetVAGSystemType, vgLibrary, IEGLConstants.CHAR_STRING, 8, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$		
		vgLibWords.put(IEGLConstants.SYSTEM_WORD_CONNECTIONSERVICE, new EGLSystemFunctionWord("connectionService", SYSTEM_WORD_VAGEN_COMPATIBILITY, IEGLConstants.Special_Function_ConnectionService, vgLibrary, null, 0, new String[] {"userid", "password", "database", "product", "release", "connectionOption"}, new String[] {IEGLConstants.CHAR8_STRING,IEGLConstants.CHAR8_STRING,IEGLConstants.CHAR18_STRING,IEGLConstants.CHAR8_STRING,IEGLConstants.CHAR8_STRING,IEGLConstants.STRING_STRING }, new int[] {IN, IN, IN, INOUT, INOUT, IN}, new int[] {3, 5, 6})); //$NON-NLS-1$
		vgLibWords.put(IEGLConstants.SYSTEM_WORD_COPYBYTES, new EGLSystemFunctionWord("copyBytes", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_CopyBytes, vgLibrary, null, 0, new String[] {"targetString", "targetIndex", "targetLength", "sourceString", "sourceIndex", "sourceLength"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
                                                                                                                                                                                        new String[] {vagText, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, vagTextOrNumeric, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING},
																																														new int[] {INOUT, IN, IN, IN, IN, IN}, new int[] { 6 }));
		vgLibWords.put(IEGLConstants.SYSTEM_WORD_COMPAREBYTES, new EGLSystemFunctionWord("compareBytes", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_CompareBytes, vgLibrary, IEGLConstants.BIN_STRING, 9, new String[] {"targetString", "targetIndex", "targetLength", "sourceString", "sourceIndex", "sourceLength"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
                                                                                                                                                                                                                       new String[] {vagText, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING, vagTextOrNumeric, IEGLConstants.INT_STRING, IEGLConstants.INT_STRING},
																																																					   new int[] {IN, IN, IN, IN, IN, IN}, new int[] { 6 }));
		vgLibWords.put(IEGLConstants.SYSTEM_WORD_CONCATENATEBYTES, new EGLSystemFunctionWord("concatenateBytes", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_ConcatenateBytes, vgLibrary, IEGLConstants.BIN_STRING, 9, new String[] {"targetString", "sourceString"}, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				                                                                                                                                                                                                                   new String[] {vagText, vagTextOrNumeric},
																																																								   new int[] {INOUT, IN}, new int[] { 2 }));
		...
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARREQUESTATTR, new EGLSystemFunctionWord("clearRequestAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_ClearRequestAttr, j2eeLibrary, null, 0, new String[] {"key"}, new String[] {IEGLConstants.CHAR_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARSESSIONATTR, new EGLSystemFunctionWord("clearSessionAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_ClearSessionAttr, j2eeLibrary, null, 0, new String[] {"key"}, new String[] {IEGLConstants.CHAR_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_GETREQUESTATTR, new EGLSystemFunctionWord("getRequestAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_GetRequestAttr, j2eeLibrary, null, 0, new String[] {"key", "argument"}, new String[] {IEGLConstants.CHAR_STRING, attribute}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_GETSESSIONATTR, new EGLSystemFunctionWord("getSessionAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_GetSessionAttr, j2eeLibrary, null, 0, new String[] {"key", "argument"}, new String[] {IEGLConstants.CHAR_STRING, attribute}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_SETREQUESTATTR, new EGLSystemFunctionWord("setRequestAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_SetRequestAttr, j2eeLibrary, null, 0, new String[] {"key", "argument"}, new String[] {IEGLConstants.CHAR_STRING, attribute}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		j2eeLibWords.put(IEGLConstants.SYSTEM_WORD_SETSESSIONATTR, new EGLSystemFunctionWord("setSessionAttr", SYSTEM_WORD_PAGEHANDLER, IEGLConstants.Special_Function_SetSessionAttr, j2eeLibrary, null, 0, new String[] {"key", "argument"}, new String[] {IEGLConstants.CHAR_STRING, attribute}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$	

		//form functions
		converseLibWords.put(IEGLConstants.SYSTEM_WORD_CLEARSCREEN, new EGLSystemFunctionWord("clearScreen", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ClearScreen, converseLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$
		converseLibWords.put(IEGLConstants.SYSTEM_WORD_DISPLAYMSGNUM, new EGLSystemFunctionWord("displayMsgNum", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_DisplayMsgNum, converseLibrary, null, 0, new String[] {"messageNumber"}, new String[] {IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$
		converseLibWords.put(IEGLConstants.SYSTEM_WORD_FIELDINPUTLENGTH, new EGLSystemFunctionWord("fieldInputLength", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_FieldInputLength, converseLibrary, IEGLConstants.BIN_STRING, 9, new String[] {textField}, new String[] { textField }, new int[] {IN}, new int[] { 1 } )); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		converseLibWords.put(IEGLConstants.SYSTEM_WORD_PAGEEJECT, new EGLSystemFunctionWord("pageEject", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_PageEject, converseLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$
		converseLibWords.put(IEGLConstants.SYSTEM_WORD_VALIDATIONFAILED, new EGLSystemFunctionWord("validationFailed", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_ValidationFailed, converseLibrary, null, 0, new String[] {"messageNumber"}, new String[] { IEGLConstants.INT_STRING}, new int[] {IN}, new int[] { 0, 1 } )); //$NON-NLS-1$ //$NON-NLS-2$
		
		//Java System Functions
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_INVOKE, new EGLSystemFunctionWord("invoke", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_Invoke, javaLibrary, IEGLConstants.BIN_STRING, 18, new String[] {"target", "method", "argument"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, anyEglPrimitive}, new int[] {IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_STORE, new EGLSystemFunctionWord("store", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_Store, javaLibrary, null, 0, new String[] {"identifier", "target", "method","argument"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, anyEglPrimitive}, new int[] {IN, IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 3 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_STORENEW, new EGLSystemFunctionWord("StoreNew", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_StoreNew, javaLibrary, null, 0, new String[] {"identifier", "class", "argument"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, anyEglPrimitive}, new int[] {IN, IN, IN}, new int[] { ARG_COUNT_N_OR_MORE, 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_GETFIELD, new EGLSystemFunctionWord("getField", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_GetField, javaLibrary, IEGLConstants.BIN_STRING, 18, new String[] {"target", "field"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING}, new int[] {IN, IN}, new int[] { 2 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_SETFIELD, new EGLSystemFunctionWord("setField", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_SetField, javaLibrary, null, 0, new String[] {"target", "field", "argument"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, anyEglPrimitive}, new int[] {IN, IN, IN}, new int[] { 3 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_STOREFIELD, new EGLSystemFunctionWord("storeField", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_StoreField, javaLibrary, null, 0, new String[] {"identifier", "target", "field"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING}, new int[] {IN, IN, IN}, new int[] { 3 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_QUALIFIEDTYPENAME, new EGLSystemFunctionWord("qualifiedTypeName", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_QualifiedTypeName, javaLibrary, IEGLConstants.STRING_STRING, 5, new String[] {"identifier"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_STORECOPY, new EGLSystemFunctionWord("storeCopy", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_StoreCopy, javaLibrary, null, 0, new String[] {"identifier", "identifier"}, new String[] {IEGLConstants.STRING_STRING, IEGLConstants.STRING_STRING}, new int[] {IN, IN}, new int[] { 2})); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_REMOVE, new EGLSystemFunctionWord("remove", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_Remove, javaLibrary, null, 0, new String[] {"identifier"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_REMOVEALL, new EGLSystemFunctionWord("removeAll", SYSTEM_WORD_NONE, IEGLConstants.Special_Function_JavaRemoveAll, javaLibrary, null, 0, new String[0], new String[0], new int[0], new int[] { 0 })); //$NON-NLS-1$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_ISNULL, new EGLSystemFunctionWord("isNull", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsNull, javaLibrary, IEGLConstants.BIN_STRING, 9, new String[] {"identifier"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		javaLibWords.put(IEGLConstants.SYSTEM_WORD_ISOBJID, new EGLSystemFunctionWord("isObjId", SYSTEM_WORD_RETURNS, IEGLConstants.Special_Function_IsObjID, javaLibrary, IEGLConstants.BIN_STRING, 9, new String[] {"identifier"}, new String[] {IEGLConstants.STRING_STRING}, new int[] {IN}, new int[] { 1 })); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
...
//?????	
	...
	public static List getLibrarySystemWords(String library) {
		...
		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_LOBLIB))
				return getLobLibWords();	
		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_JAVALIB))
				return getJavaLibWords();
		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_DATETIMELIB))
				return getDateTimeLibWords();	
		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_J2EELIB) && EGLBasePlugin.isJSF())
			return getJ2EELibWords();	
		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_SERVICELIB))
			return getServiceLibWords();	
		else if (library.equalsIgnoreCase(dliLibrary) && EGLBasePlugin.isDLI())
			return getDLILibWords();
		else if (library.equalsIgnoreCase(dliVariablesLibrary) && EGLBasePlugin.isDLI())
			return getDLIVarWords();
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_VGLIB))
//			return getVGLibWords();	
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_VGVAR))
//			return getVGVarWords();		
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_CONVERSEVAR))
//			return getConverseVarWords();
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_REPORTLIB))
//			return getReportLibWords();	
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_CONSOLELIB))
//			return getConsoleLibWords();
//		else if (library.equalsIgnoreCase(IEGLConstants.KEYWORD_CONVERSELIB))
//				return getConverseLibWords();			
