 ...
 * @author demurray
 */
public class PositionForFormFieldValidator extends DefaultFieldContentAnnotationValidationRule {
		...
		if(annotationBinding != null) {
			...
			if(!valueIsValid) {
				problemRequestor.acceptProblem(
					errorNode,
					IProblemRequestor.INVALID_FORM_FIELD_POSITION_PROPERTY_VALUE,
					new String[] {
