 ...
 */
public class EGLSQLKeywordTool {

	public static void main(String[] args) {
		StringBuffer stringBuffer = new StringBuffer();
		System.out.println();
		System.out.println("	//EGL SQL keywords"); //$NON-NLS-1$
		System.out.print("	//Generated :  "); //$NON-NLS-1$
		System.out.println(new Date().toString());
		System.out.println("	//These keywords should be generated by org.eclipse.edt.compiler.internal.dev.tools.EGLSQLKeywordTool"); //$NON-NLS-1$
		...
		for (int i = 0; i < keywords.length; i++) {
			...
			stringBuffer.append("SQLKEYWORD_"); //$NON-NLS-1$
