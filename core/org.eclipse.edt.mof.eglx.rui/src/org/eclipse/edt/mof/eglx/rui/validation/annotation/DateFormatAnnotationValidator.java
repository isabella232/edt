...
public class DateFormatAnnotationValidator extends AnnotationValidationRule {
	...
	public DateFormatAnnotationValidator() {
		super(NameUtile.getAsCaseSensitiveName("dateformat"));
	}
	...
	public void validate(Node errorNode, Node target, Element targetElement, Map<String, Object> allAnnotationsAndFields, IProblemRequestor problemRequestor, ICompilerOptions compilerOptions){
		...
		// string, date, and numerics are valid. everything else is invalid.
		if (TypeUtils.Type_STRING.equals(type) || TypeUtils.Type_DATE.equals(type) || TypeUtils.isNumericType(type)) {
			return;
		}
