...
import org.eclipse.edt.mof.eglx.rui.validation.annotation.OnConstructionFunctionAnnotationValueValidator;
import org.eclipse.edt.mof.utils.NameUtile;

public class RUIWidgetAnnotationProxy extends AbstractValidationProxy {
	private static RUIWidgetAnnotationProxy INSTANCE = new RUIWidgetAnnotationProxy();
	...
	private RUIWidgetAnnotationProxy() {
	}
	
	public static RUIWidgetAnnotationProxy getInstance() {
		return INSTANCE;
	}
