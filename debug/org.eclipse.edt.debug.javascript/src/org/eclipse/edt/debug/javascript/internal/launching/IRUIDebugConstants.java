...
/**
 * Constants for the RUI debugger.
 */
public interface IRUIDebugConstants
{
	
	/**
	 * Unique identifier for the RUI debug model (value <code>org.eclipse.edt.debug.javascript.rui</code>).
	 */
	public static final String ID_RUI_DEBUG_MODEL = "org.eclipse.edt.debug.javascript.rui"; //$NON-NLS-1$
