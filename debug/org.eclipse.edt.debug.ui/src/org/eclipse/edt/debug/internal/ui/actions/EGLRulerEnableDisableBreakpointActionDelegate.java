...
public class EGLRulerEnableDisableBreakpointActionDelegate extends AbstractRulerActionDelegate
{
	/*
	 * (non-Javadoc)
	...
	{
		return new EGLRulerEnableDisableBreakpointAction( editor, rulerInfo );
	}
}
