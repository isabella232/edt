egl.defineClass('common', "List", "egl.jsrt", "Record", {
	"eze$$fileName" : "common/ChattyGabbyRecords.egl",
		...
		"eze$$getChildVariables": function() {
			var eze$$parent = this;
			return [
			{name: "pstid", value : eze$$parent.pstid, type : "eglx.lang.EInt", jsName : "pstid"},
			{name: "crtts", value : eze$$parent.crtts, type : "eglx.lang.EString", jsName : "crtts"},
			{name: "usrid", value : eze$$parent.usrid, type : "eglx.lang.EString", jsName : "usrid"},
			{name: "txt", value : eze$$parent.txt, type : "eglx.lang.EString", jsName : "txt"}
			];
		}
	}
);
