define(["org/eclipse/edt/eunit/runtime/LogResult"],function(){
	if (egl.eze$$userLibs) egl.eze$$userLibs.push('backup.resultLib');
	else egl.eze$$userLibs = ['backup.resultLib'];
	egl.defineRUILibrary('backup', 'resultLib',
	{
		'eze$$fileName': 'backup/resultLib.egl',
		'eze$$runtimePropertiesFile': 'backup.resultLib',
			"constructor": function() {
				if(egl.backup.resultLib['$inst']) return egl.backup.resultLib['$inst'];
				egl.backup.resultLib['$inst']=this;
