...
public class DataAreaLib extends ExecutableBase {
	...
	private void check4NullArea(DataArea dataarea, String path, String functioName) {
		if ((org.eclipse.edt.runtime.java.eglx.lang.NullType.equals(dataarea, null))) {
			...
			if ((org.eclipse.edt.runtime.java.eglx.lang.NullType.notEquals(path, null))) {
	...
	private void returnAS400ToPool(DataArea dataArea) {
		if ((org.eclipse.edt.runtime.java.eglx.lang.NullType.notEquals(dataArea, null))) {
			eze_Lib_org_eclipse_edt_jtopen_data_common_CommonLib().returnAS400ToPool(dataArea.getSystem());
		}
	}
}
